...
class Cog(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.config = {
            ...
            762031849236856872:{"ReactRoleEmoji":"<:MKB:983361088529764452>", "HostRoleEmoji":"<:host:1180945564905508934>"}
            }
    ...
    async def b(self, ctx: commands.Context, *category_names):
        ...
        for category_name in category_names:
            ...
            if category_name == "各組連絡用":
                ...
                await channel.set_permissions(target=role_shinkou, send_messages = False)
